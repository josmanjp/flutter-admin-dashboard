          ...
          children: [
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                double minContentHeight = 500; // Altura mínima estimada del formulario + título
                double minContentWidth = 900;  // Ancho mínimo para desktop (600 form + 300 background)
                
                // Verificamos si hay suficiente espacio real
                bool fitsDesktopLayout = hasEnoughWidth && 
                                       hasEnoughHeight && 
